          ...
          <div className={style.main_content_body}>
            <div className={style.main_featured_content}>
              ...
              <div className={style.offer_info}>
                <img src={`../../../assets/img/hotel (3).jpg`} alt='hotel' className={style.offer_img} />
                <img src={`../../../assets/img/hotel (2).jpg`} alt='hotel' className={style.offer_img} />
              </div>
            </div>
            ...
            <div className={style.main_curated_content}>
              ...
              <div className={style.curated_hotel_container}>
                <div className={style.curated_container}>
                  ...
                  <p className={` ${style.place_name} ${style.my_property}`}>Sea view hotels in India</p>
                  <p className={` ${style.properties} ${style.my_property}`}>212 properties avaible</p>
                </div>
                <div className={style.curated_container}>
                  <img src={`../../../assets/img/hotel (2).jpg`} alt='hotel' className={style.curated_img} />
                  <p className={` ${style.place_name} ${style.my_property}`}>Hill View Hotel in NewYork</p>
                  <p className={` ${style.properties} ${style.my_property}`}>200 properties avaible</p>
                </div>
                <div className={style.curated_container}>
                  <img src={`../../../assets/img/hotel (5).jpg`} alt='hotel' className={style.curated_img} />
                  <p className={` ${style.place_name} ${style.my_property}`}>Luxery Hotel Dubai</p>
                  <p className={` ${style.properties} ${style.my_property}`}>234 properties avaible</p>
                </div>
              </div>
            </div>
            ...
            <div className={style.main_footer}>
              ...
              <div className={style.footer_main}>
                <div className={style.footer_content}>
                  <div className={style.footer_logo_container}>
                    <img src={`../../../assets/img/wheel.png`} alt='logo' className={style.footer_logo} />
                  </div>
                </div>
                <div className={style.footer_content}>
                  <h4 className={`${style.footer_content_title}${style.headings}`}>10M+ Happy Costumers</h4>
