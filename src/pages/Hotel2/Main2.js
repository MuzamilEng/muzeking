        ...
        <div className={style.main2_fields}>
          ...
          <div className={style.main2_wrapper}>
            ...
            <div className={style.resturant_h2}>
              ...
              <Resturant hotelT='The Orchid Hotel' location='Achram Road, Amdabad' />
              <Resturant hotelT='WishLing Meadows Resort' location='SH Highway, Amdabad' />
              <Resturant hotelT='Readison Blue Hotel' location='Electronic City Amdabad' />
              <Resturant hotelT='Lotus Hotel' location='Airport Zone, Amdabad' />
              <Resturant hotelT='Eulogia Central Resort' location='Samad Highways' />
