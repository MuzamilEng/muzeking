      ...
      <div className={style.h3_rooms_body}>
        <div className={style.room_wrapper}>
          ...
          <div className={style.room_statics}>
            <h1 className={` ${style.logo_room} ${style.headings}`}>
              {props.roomTitle}
            </h1>
            <div className={style.statistics}>
              <div className={style.statics_content}>
                <li className={style.statics_icons}>
                  ...
                  <p className={` ${style.bed_info} ${style.my_property}`}>
                    {props.bedSize}
                  </p>
                </li>
                <li className={style.statics_icons}>
                  <img
                    src={`../../../assets/img/green1.png`}
                    alt="search"
                    className={style.bed_icons}
                  />
                  <p className={` ${style.bed_info} ${style.my_property}`}>
                    {props.bathHub}
                  </p>
            ...
            <div className={style.price_information}>
              <p className={style.price}>
                <span className={` ${style.bolder} ${style.my_property}`}>
                  {props.price}
                </span>
              </p>
              ...
              <p className={style.price}>
                <span
                  className={` ${style.green} ${style.bolder} ${style.my_property}`}
                >
                  {props.off}
                </span>
              </p>
              <p className={` ${style.price} ${style.my_property}`}>
                {props.stayTime}
              </p>
            </div>
            <div className={style.room_btn_section}>
              <p className={style.consult}>Consultation Policy</p>
              <button className={` ${style.select_room} ${style.my_property}`}>
                Select Room
              </button>
            </div>
          </div>
